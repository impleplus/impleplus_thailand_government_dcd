...
class Table_EFXhjQ extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/water_user",accessAction,"water_userRecords","water_userRecordsPagination",{url:"/water_user/delete",message:"Are you sure delete data ?"},{url:"/water_user/edit",target:""}, 
            {url:"/water_user/export"},["data.water_user_number?data.water_user_number:''","data.water_user_name?data.water_user_name:''","data.address?data.address:''","data.phone?data.phone:''","data.social?data.social:''"], "", "tbl-table_EFXhjQ", "tbl-table_EFXhjQ-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_gVGyiS extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/electricity_user",accessAction,"electricity_userRecords","electricity_userRecordsPagination",{url:"/electricity_user/delete",message:"Are you sure delete data ?"},{url:"/electricity_user/edit",target:""}, 
            {url:"/electricity_user/export"},["data.electricity_user_number?data.electricity_user_number:''","data.electricity_user_name?data.electricity_user_name:''","data.address?data.address:''","data.phone?data.phone:''","data.social?data.social:''"], "", "tbl-table_gVGyiS", "tbl-table_gVGyiS-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_tiHtvn extends PageList {
        constructor(instName,accessAction) {
            ...
            {url:"/bill_electricity/export"},["data.electricity_user_name?data.electricity_user_name:''","data.month?data.month:''","data.amount?data.amount:''","data.payment_status_text?data.payment_status_text:''"], "", "tbl-table_tiHtvn", "tbl-table_tiHtvn-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_ucOjdc extends PageList {
        constructor(instName,accessAction) {
            ...
            {url:"/bill_water/export"},["data.water_user_name?data.water_user_name:''","data.month?data.month:''","data.amount?data.amount:''","data.payment_status_text?data.payment_status_text:''"], "", "tbl-table_ucOjdc", "tbl-table_ucOjdc-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_gQgtcE extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/bill_electricity/report",accessAction,"bill_electricityRecords","bill_electricityRecordsPagination",{url:"",message:""},{url:"",target:""}, 
            {url:"/bill_electricity/report/export"},["data.province_electricity_branch_id?data.province_electricity_branch_id:''","data.electricity_user_id?data.electricity_user_id:''","data.month?data.month:''","data.amount?data.amount:''","data.payment_status?data.payment_status:''","data.payment_receipt_number?data.payment_receipt_number:''","data.remark?data.remark:''","data.year?data.year:''"], "", "tbl-table_gQgtcE", "tbl-table_gQgtcE-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
